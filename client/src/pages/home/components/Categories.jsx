        ...
        <div className='wrapper'>
            <div className='categories-container grid grid-cols-12 grid-rows-12 lg:gap-x-[40px] gap-y-3 h-[1000px] lg:h-[600px]  '>
                <div className='women-cate cursor-pointer col-span-12 row-span-6  lg:col-span-6 lg:row-span-12 relative'>
                    ...
                    <button onClick={(e)=>handleCatebtn(e)} data-cate="FFFF" className='w-[150px] h-[40px] absolute bg-white text-black bottom-[20px] left-[50%] translate-x-[-50%] font-medium transition-all ease-in-out duration-500 hover:bg-black hover:text-white ' data-cate="women">Women</button>
                </div>
